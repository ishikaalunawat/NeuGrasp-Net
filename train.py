...
parser.add_argument('--dataset_dir', type=str, default='./raw_data_final')
parser.add_argument('--save_dir', type=str, default='./edge_grasp_net_finaltrained_para')
parser.add_argument('--vn_save_dir', type=str, default='./vn_edge_finaltrain_para')
