...
from vgn.ConvONets.conv_onet.models.utils.layers_equi import *
...
class LocalPool_VN_DGCNN(nn.Module):
    ''' VectorNeuron-DGCNN encoder (point-wise) with projection to local plane/grid features
        ...
        A dot product between the 3D vector neuron features and the 3D voxel co-ordinate
        is used to get a scalar feature for each voxel
