...
class DatasetAffnetVoxelOccFile(torch.utils.data.Dataset):
    def __init__(self, root, raw_root, num_point=2048, num_point_occ=8000, augment=False):
        ...
        self.df = read_df_with_surface_clouds(raw_root) # read with surf clouds but don't use clouds
    ...
    def __getitem__(self, i):
        ...
        tsdf, y, rot = voxel_grid[0], (label, aff_labels), rotation
