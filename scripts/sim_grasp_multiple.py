...
def main(args):
    ...
    if args.type in ['giga', 'giga_hr', 'giga_hr_deeper', 'giga_aff', 'neu_grasp_pn', 'neu_grasp_pn_deeper', 'pointnetgpd',
                     'neu_grasp_pn_no_local_cloud', 'neu_grasp_dgcnn', 'neu_grasp_dgcnn_deeper', 'neu_grasp_vn_pn_pn']:
