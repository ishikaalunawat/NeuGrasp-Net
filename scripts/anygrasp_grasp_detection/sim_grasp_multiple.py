...
def main(args):
    ...
    if args.type in ['giga', 'giga_hr', 'giga_hr_deeper', 'giga_aff', 'neu_grasp_pn', 'neu_grasp_pn_deeper', 'neu_grasp_pn_deeper4', 'pointnetgpd',
        ...
        from anygrasp_planner import AnyGraspPlanner
        grasp_planner = AnyGraspPlanner(checkpoint_path=args.model,
                                        max_gripper_width=0.08,
                                        gripper_height=0.045,
                                        force_detection=args.force,
                                        qual_th=args.qual_th,
                                        debug=args.debug)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--qual_th", type=float, default=0.3)
